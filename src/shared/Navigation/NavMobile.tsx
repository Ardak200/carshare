    ...
    <div className="overflow-y-auto w-full max-w-sm h-screen py-2 transition transform shadow-lg ring-1 dark:ring-neutral-700 bg-white dark:bg-neutral-900 divide-y-2 divide-neutral-100 dark:divide-neutral-800">
      <div className="py-6 px-5">
        ...
        <div className="flex flex-col mt-5 text-neutral-700 dark:text-neutral-300 text-sm">
          <span>
            Вы можете взять напрокат машину и арендовать собственный автомобиль вместе с CarShare
          </span>
      ...
      <div className="flex items-center justify-between py-6 px-5 space-x-4">
        {!keycloak.authenticated?
            <a onClick={login} target="_blank" rel="noopener noreferrer">
              <ButtonPrimary>Войти</ButtonPrimary>
            </a> :
            <a onClick={() => keycloak.logout()} target="_blank" rel="noopener noreferrer">
              <ButtonPrimary>Выйти</ButtonPrimary>
            </a>
        }
