...
const AddressInputRegion: FC<LocationInputProps> = ({
                                                   defaultValue,
                                                   autoFocus = false,
                                                   onChange,
                                                   onInputDone,
    ...
    return (
        ...
        <div className={`relative flex ${className}`} ref={containerRef}>
            ...
            {showPopover && (
                ...
                // </div>
                <>
                    <CityAndRegion show={showPopover} setShow={setShowPopover} location={location} setLocation={setLocation}/>
                </>
            )}
        </>
    );
...
export default AddressInputRegion;
